...
<div id="formContainer">
    ...
    <form action="" method="post">
        <fieldset>
            ...
            <p>
                <label class="field" for="password2">Slaptažodis<?php echo in_array('password2', $required) ? '<span> *</span>' : ''; ?></label>
                <input type="password" id="password2" name="password2" class="textbox-150" value="<?php echo isset($fields['password2']) ? $fields['password2'] : ''; ?>" />
                <?php if(key_exists('password2', $maxLengths)) echo "<span class='max-len'>(iki {$maxLengths['password2']} simb.)</span>"; ?>
            </p>
        </fieldset>
        <p class="required-note">* pažymėtus laukus užpildyti privaloma</p>
        <p>
            <input type="submit" class="submit" name="submit" value="Registruotis">
        </p>
    </form>
</div>
